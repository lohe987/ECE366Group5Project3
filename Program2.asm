...
MOVI 3
ADDI 1 #R0=4
LOAD 0 #R0=MEM[4]=highest current score
SUB 4  #R0=R0-R4=-,0,+
SAR 7
MOVI 3
ADDI 3 #R7=6
...
MOVI 0
SAR 0
BSLT 7 #if R0<0 then branch to NEWMAX else continue
SAR 7
MOVI 3
ADDI 3
ADDI 1 #R7=7
...
MOVI 1
SAR 0
BSLT 7 #if R0<1 then branch to MAXEQUAL else continue
SAR 7
MOVI 3
ADDI 3
ADDI 1
...
ADDI 1 #R7=4
SAR 0
STOR 7 #R0=MEM[4]=highest score
SAR 7
ADDI 1 #R7=5
SAR 3
STOR 7 #R1=MEM[5]=number of highest score
SAR 7
MOVI 3
ADDI 3
ADDI 2 #R7=8
